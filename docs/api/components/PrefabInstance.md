...
`PrefabInstance` is a (case-sensitive) built-in component name that records which prefab an Instance came from.
...
| --- | --- | --- |
| `id` | `u32` | Interned prefab ID; editor label: PrefabId |

...
`UIScrollingFrame` is a (case-sensitive) built-in component name that stores a scrolling frame's canvas size.
...
| --- | --- | --- |
| `canvas_size.x.scale` | `f32` |  |
| `canvas_size.x.offset` | `f32` |  |
| `canvas_size.y.scale` | `f32` |  |
| `canvas_size.y.offset` | `f32` |  |

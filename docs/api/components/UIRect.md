...
`UIRect` is a (case-sensitive) built-in component name that stores a UI element's rectangle and sizing behavior.
...
| --- | --- | --- |
| `position.x.scale` | `f32` |  |
| `position.x.offset` | `f32` |  |
| `position.y.scale` | `f32` |  |
| `position.y.offset` | `f32` |  |
| `size.x.scale` | `f32` |  |
| `size.x.offset` | `f32` |  |
| `size.y.scale` | `f32` |  |
| `size.y.offset` | `f32` |  |
...
| `anchor_x` | `f32` |  |
| `anchor_y` | `f32` |  |
| `size_mode[0]` | `u8` | X-axis enum |
| `size_mode[1]` | `u8` | Y-axis enum |
